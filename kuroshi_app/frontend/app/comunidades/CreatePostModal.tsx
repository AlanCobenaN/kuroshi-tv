    ...
    <div className="cpm-overlay">
      <div className="cpm-modal" ref={modalRef} role="dialog" aria-modal="true" aria-label="Crear publicación">
        ...
        <div className="cpm-toolbar">
          ...
          <button onClick={() => setShowGifSearch(!showGifSearch)} className={`cpm-tb-btn ${showGifSearch ? 'cpm-tb-btn--active' : ''}`} title="GIF" aria-label="Insertar GIF">
      ...
      <style>{`
        ...
        .cpm-giphy { padding: 0 1.25rem 0.75rem; }
